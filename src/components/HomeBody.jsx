  ...
  <Container style={{ maxWidth: '1000px' }}>
      <Card style={cardStyle}>
        ...
        <div style={{ overflowY: 'auto', maxHeight: '400px' }}>
          ...
          <Col>
                    <Card>
                    <Card.Img variant="top" className="custom-height-image" src="https://bmkltsly13vb.compat.objectstorage.ap-singapore-1.oraclecloud.com/cdn.sg.dailymirror.lk/assets/uploads/image_b2ec3f586d.jpg"/>
                    <Card.Body>
                        <Card.Title>Sri Lanka edge out Afghanistan in low-scoring thriller</Card.Title>
                        <Card.Text>
                ...
                <Col>
                    <Card>
                    <Card.Img variant="top"  className="custom-height-image" src="https://bmkltsly13vb.compat.objectstorage.ap-singapore-1.oraclecloud.com/cdn.sg.dailymirror.lk/assets/uploads/image_80ea81f0aa.jpg" />
                    <Card.Body>
                        <Card.Title>Wade guides Australia to series-clinching win</Card.Title>
                        <Card.Text>
                        Australia were made to work hard in chasing a modest target of 125 but the steady hands of Matthew Wade took them
                         to a series-clinching win in the second T20I against Sri Lanka at the R Premadasa Stadium yesterday.
                        </Card.Text>
                    </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card>
                    <Card.Img variant="top"  className="custom-height-image" src="https://bmkltsly13vb.compat.objectstorage.ap-singapore-1.oraclecloud.com/cdn.sg.dailymirror.lk/assets/uploads/image_b2cdd8cbed.jpg" />
                    <Card.Body>
                        <Card.Title>Shanaka backs world-class bowling attack to succeed against World Champions</Card.Title>
                        <Card.Text>
                        Sri Lanka’s T20 captain Dasun Shanaka believes his team’s world-class bowling line-up can rein in the World Cup-winning Australian batting line-up, starting with the first T20 International at the R. Premada Stadium today.
                        </Card.Text>
                    </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card>
                    <Card.Img variant="top"  className="custom-height-image" src="https://bmkltsly13vb.compat.objectstorage.ap-singapore-1.oraclecloud.com/cdn.sg.dailymirror.lk/assets/uploads/image_8886c6ae16.jpg" />
                    <Card.Body>
                        <Card.Title>Confident in how our game holds up in these conditions - Hazlewood</Card.Title>
                        <Card.Text>
                        Australian fast-bowler Josh Hazlewood said that his team will come into their multi-format tour of Sri Lanka carrying significantly more confidence in handling sub-continental conditions than was pres
                        </Card.Text>
                    </Card.Body>
                    </Card>
                </Col>
